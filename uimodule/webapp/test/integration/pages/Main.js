sap.ui.require([
  ...
  var sViewName = "it.cubeconsultants.site.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "it.cubeconsultants.site"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title it.cubeconsultants.site"
            });
        }
      }
